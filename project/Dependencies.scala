...
object Dependencies {
    ...
    object V {
        ...
        val catsRetry = "3.1.0"
        val circe = "0.14.6"  // UNCOMMENTED: Add Circe version
        val ciris = "3.0.0"
        val comcast = "3.2.0"
        val decline = "2.4.1"
        val derevo = "0.13.0"
    ...
    object Libraries {
        def circe(artifact: String, version: String = V.circe): ModuleID = "io.circe" %% s"circe-$artifact" % version  // UNCOMMENTED
        ...
        // UNCOMMENTED: Circe dependencies
        val circeCore = circe("core")
        val circeGeneric = circe("generic")
        val circeParser = circe("parser")
        val circeRefined = circe("refined")
        val circeFs2 = circe("fs2", "0.14.1")  // Updated version
