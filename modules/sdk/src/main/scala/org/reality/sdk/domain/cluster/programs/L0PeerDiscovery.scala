...
import org.reality.schema.peer.{L0Peer, P2PContext, PeerId}
import org.reality.sdk.domain.cluster.programs.L0PeerDiscovery.L0PeerDiscoveryError
import org.reality.sdk.domain.cluster.storage.L0ClusterStorage
import org.reality.sdk.http.p2p.clients.L0ClusterClient
...
sealed abstract class L0PeerDiscovery[F[_]: Sync: Random] private (
  ...
  def discoverFrom(peer: P2PContext): F[Unit] =
    getPeersFrom(peer)
      ...
      .handleErrorWith { e =>
        logger.error(e)(s"Error during L0 peer discovery!! - " + peer.toString + s" - $e") >>
