...
final case class ConsensusRounds[F[_], K <: HealthCheckKey, A <: HealthCheckStatus, B <: ConsensusHealthStatus[
  K,
  A
...
object ConsensusRounds {
  private type Rounds[F[_], K <: HealthCheckKey, A <: HealthCheckStatus, B <: ConsensusHealthStatus[
    K,
    A
  ], C <: HealthCheckConsensusDecision] =
