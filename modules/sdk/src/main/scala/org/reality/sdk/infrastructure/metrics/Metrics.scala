package org.reality.sdk.infrastructure.metrics
...
import org.reality.sdk.infrastructure.metrics.Metrics.{MetricKey, TagSeq}
...
object Metrics {
  ...
  type MetricKey = String Refined MatchesRegex["net_[a-z0-9]+(?:_[a-z0-9]+)*"]
