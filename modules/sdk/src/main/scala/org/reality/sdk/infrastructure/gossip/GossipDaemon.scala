...
import org.reality.sdk.config.types.GossipDaemonConfig
...
import org.reality.sdk.infrastructure.gossip.RumorStorage.{AddSuccess, CounterTooHigh}
...
object GossipDaemon {
  ...
  def make[F[_]: Async: SecurityProvider: Random: Parallel: Metrics](
