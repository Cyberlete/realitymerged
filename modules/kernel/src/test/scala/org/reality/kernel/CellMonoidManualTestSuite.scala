...
//  import TestCells._
//
//  implicit val M: Monoid[Cell[Id, Ω, StackF, Ω, Either[CellError, Ω]]] = Cell.cellMonoid[Id, StackF]
//
//  test("creates empty") {
//    val empty = M.empty
//
...
//    val intToStringCell: Cell[Id, Ω, StackF, Ω, Either[CellError, Ω]] = LongToStringCell(TestLongInput(1L))
//    val stringToIntCell: Cell[Id, Ω, StackF, Ω, Either[CellError, Ω]] = StringToLongCell(TestStringInput("2"))
//
...
//        extends Cell[Id, Ω, StackF, Ω, Either[CellError, Ω]](
//          input,
//          scheme.hyloM(
