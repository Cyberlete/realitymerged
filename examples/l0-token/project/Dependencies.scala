...
object Dependencies {
  ...
  object Libraries {
    ...
    def reality(artifact: String): ModuleID = "org.reality" %% s"reality-$artifact" % V.reality % Provided
    ...
    val realityKernel = reality("kernel")
    val realityShared = reality("shared")
  }
}
